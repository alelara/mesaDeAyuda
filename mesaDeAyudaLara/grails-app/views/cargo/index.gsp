		...
		<div id="list-cargo" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="nombre" title="${message(code: 'cargo.nombre.label', default: 'Nombre')}" />
				...
				<g:each in="${cargoInstanceList}" status="i" var="cargoInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${cargoInstance.id}">${fieldValue(bean: cargoInstance, field: "nombre")}</g:link></td>
