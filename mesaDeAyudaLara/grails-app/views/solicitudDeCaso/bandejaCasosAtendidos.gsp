                    ...
                    <div class="col-md-1">
                      <div class="left-content">
                          <div class="list-group"> 
                              <a href="${createLink(controller:'solicitudDeCaso', action:'bandejaDeCasos')}" class="list-group-item active"><i class="entypo-inbox"></i><b>Bandeja</b></a> 
                              ...
                              <sec:ifAnyGranted roles="ROLE_ADMIN,ROLE_ATENCION"> 
                                  <a href="${createLink(controller:'solicitudDeCaso', action:'bandejaCasosAtendidos')}" class="list-group-item"><i class="glyphicon glyphicon-check"></i><b>Archivo de Casos Atendidos</b><span class="badge">${casoInstanceCount}</span></a> 
                              </sec:ifAnyGranted>
                          ...
                          <table class="table table-condensed table-striped margin-0px">
                            ...
                            <g:each in="${casos}" var="ticket" name="casos">    
                              <tr class="unread">
                                ...
                                <td>${ticket?.caso?.fechaDeCierre}</td>
                                        <sec:ifAnyGranted roles="ROLE_ADMIN,ROLE_ATENCION"> 
