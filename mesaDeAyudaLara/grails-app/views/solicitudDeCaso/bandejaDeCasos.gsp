                                ...
                                <div class="row">
                                    <div class="col-md-1">
                                        <div class="left-content">
                                            <div class="list-group"> <a href="#" class="list-group-item active"><i class="entypo-inbox"></i><b>Bandeja</b><span class="badge">${casoInstanceCount}</span></a> 
                                                ...
                                                <sec:ifAnyGranted roles="ROLE_ADMIN,ROLE_ENLACE"> 
                                                    <a href="${createLink(controller:'solicitudDeCaso', action:'bandejaCasosProceso')}" class="list-group-item"><i class="entypo-archive"></i><b>Archivo de Casos en Proceso</b></a> 
                                                </sec:ifAnyGranted> 
                                                <sec:ifAnyGranted roles="ROLE_ADMIN,ROLE_ATENCION">   
                                    ...
                                    <div class="col-md-11">
                                        <div class="right-content clearfix">
                                            <div class="big-icons-buttons clearfix margin-bottom">
                                                <a href="${createLink(controller:'solicitudDeCaso', action:'altaDeTicket')}" class="btn btn-sm btn-default"><i class="fa fa-envelope"></i>Nuevo Ticket</a>
                                                <sec:ifAnyGranted roles="ROLE_ADMIN,ROLE_ATENCION">     
                                                    <a href="${createLink(controller:'configuracion', action:'altaTeamViewer')}" class="btn btn-sm btn-default"><i class="fa fa-laptop"></i>&nbsp;&nbsp;TeamViewer&nbsp;&nbsp;</a>
                                                    <a href="${createLink(controller:'configuracion', action:'altaLlamada')}" class="btn btn-sm btn-default"><i class="fa fa-phone-square"></i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Llamada&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
                                                    <a href="${createLink(controller:'configuracion', action:'altaSitio')}" class="btn btn-sm btn-default"><i class="fa fa-taxi"></i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;En Sitio&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>                          
                                                </sec:ifAnyGranted>
                                            </div>
                                            ...
                                            <div class="panel panel-default">
                                                <div class="panel-body">
                                                    ...
                                                    <g:if test="${botelaExitosa}">
                                                        <div class="callout callout-info">
                                                            <h4>Operación Ejecutada Correctamente</h4>
                                                            <p>${botelaExitosa}</p>
                                                        </div>                                
                                                    </g:if>
                                                </div>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <g:each in="${casos}" var="ticket" name="casos">    
                                                            <tr class="unread">
                                                                ...
                                                                <td><a href="#" class="pull-right"><i class="fa fa-calendar"></i></a> <a href="#">${ticket?.categoria}</a><small>Número de Ticket: ${ticket?.caso?.id}</small></td>
                                                                <td>${ticket?.caso?.fechaDeCreacion}<small></small></td>
                                                        <sec:ifAnyGranted roles="ROLE_ADMIN,ROLE_ATENCION"> 
