...
<html>
    ...
    <body>
          ...
          <ul>
            ...
            <li class="active">Creacion de Ticket</li>
          </ul>
        </div>
        <!--/Breadcrumb-->
        
        <div class="page-header">
          <h1>Creacion de ticket<small>${usuario?.unidad}</small></h1>
        </div>
   ...
   <div class="col-md-12  bootstrap-grid">
            ...
            <div class="powerwidget green"  data-widget-editbutton="false">
              <header>
                <h2>Seleccionar Area<small>Paso 1</small></h2>
              </header>
              <div class="inner-spacer">
                <g:formRemote  url="[controller: 'solicitudDeCaso', action:'buscarReposotorioAyuda']"  name="buscarReposotorioAyuda" class="orb-form" update="repositotioAyuda">
                  <fieldset>
                    <section>
            ...
            update:'categoria')}" required="true"/> 
                  ...
                  <footer>
                      <button id="btn-paso1" type="submit" class="btn btn-default">Siguiente</small></button>
                  </footer>
                </g:formRemote>
              </div>
            </div>
