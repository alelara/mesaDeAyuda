                          ...
                          <table class="table table-condensed table-striped margin-0px">
                            ...
                            <g:each in="${casos}" var="ticket" name="casos">    
                              <tr class="unread">
                                ...
                                <td>  
                                    <g:if test="${ticket?.caso?.encuestaResuelta}">
                                        <button class="btn btn-success"><i class="fa fa-check-square"></i> Encuesta Contestada</button>
                                    </g:if>
                                    <g:else>
                                    <a href="${createLink(controller:'encuesta', action:'altaEncuesta', params:['caso':ticket?.caso?.id])}" class="btn btn-danger" style="color: #FFF;"> <i class="fa fa-exclamation-circle"></i> Contestar Encuesta&nbsp;&nbsp;</a>
                                    </g:else>
                                </td>
                              </tr>
                             </g:each>
