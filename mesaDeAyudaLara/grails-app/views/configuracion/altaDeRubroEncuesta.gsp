        ...
        <div class="col-md-12  bootstrap-grid">
            <div class="powerwidget green" id="most-form-elements" data-widget-editbutton="false">
              ...
              <div class="inner-spacer">
                ...
                <g:form  url="[controller: 'configuracion', action:'guardarRubroEncuesta']" class="orb-form">  
                    <fieldset>
                    <section>
                  ...
                  <fieldset>
                    <section>
                      ...
                      <label class="input">
                          <input type="text" name="rubro" required="true">
                      </label>
                    </section>
                  ...
                  <footer>
                    <button type="submit" class="btn btn-success">Agregar Rubro</button>
                  </footer>
                </g:form>
              </div>
            </div>
