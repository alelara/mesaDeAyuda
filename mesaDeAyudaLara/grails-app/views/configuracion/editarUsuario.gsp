        ...
        <div class="col-md-12  bootstrap-grid">
            <div class="powerwidget green" id="most-form-elements" data-widget-editbutton="false">
              ...
              <div class="inner-spacer">
                ...
                <g:form  url="[controller: 'configuracion', action:'updateUsuario']" class="orb-form"> 
                    <input type="hidden" name="idUser" value="${user?.id}">
                    <fieldset>
                    <section>
                      <label class="label">Nombre</label>
                      <label class="input">
                          <input id="categoria" name="nombre" required="" value="${user?.nombre}"/>
                      </label>
                    </section>
                  </fieldset> 
                  ...
                  <fieldset>
                    <section>
                      ...
                      <label class="select">
                            <g:select id="cargo" name="cargoId" from="${mx.gob.ifr.rt.Cargo.list()}" optionKey="id" required="" value="${usuarioInstance?.cargo?.id}" class="many-to-one"/>
                        <i></i> </label>
                    </section>
                  </fieldset>
                    ...
                    <section>
                      ...
                      <label class="select">
                        <g:select id="unidad" name="unidadId" from="${mx.gob.ifr.rt.UnidadAdministrativa.list()}" optionKey="id" required="" value="${usuarioUnidadAdministrativaInstance?.unidad?.id}" class="many-to-one"/>
                     </label>
                    </section>
                  </fieldset>
                  ...
                  <footer>
                    <g:submitButton  class="btn btn-success" name="update" value="Actualizar Usuario" onclick="return confirm('¿Esta seguro(a) que desea Actualizar el Resgistro?')"/>
                  </footer>
                </g:form>
              </div>
            </div>
