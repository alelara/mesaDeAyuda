...
<%@ page import="mx.gob.ifr.rt.Usuario" %>
<!DOCTYPE html>
<html>
	<head>
			...
			<ol class="property-list usuario">
				...
				<li class="fieldcontain">
					<span id="cargo-label" class="property-label"><g:message code="usuario.cargo.label" default="Cargo" /></span>
						...
						<span class="property-value" aria-labelledby="cargo-label"><g:link controller="cargo" action="show" id="${usuarioInstance?.cargo?.id}">${usuarioInstance?.cargo?.encodeAsHTML()}</g:link></span>
